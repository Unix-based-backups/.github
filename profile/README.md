...
## This is my organisation for backups of my configs
> All configs are private. This is due to the share of using other people's code snippets, ideas, and proprietary programs and fonts in them. I do not want to violate anyone's copyright and do not set out to infringe on anyone, **_so I accept ONLY those people whom I know PERSONALLY into this organization_**

For a while, I only had 1 repository to store all my configs, but over time there became so many of them that I began to get confused about them myself. That's why I created this organization with configs for different distributions and operating systems
